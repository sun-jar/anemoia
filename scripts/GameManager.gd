...
var doors = [null, Vector2i(55, -46), Vector2i(62, -17), Vector2i(59, 7), Vector2i(33, 69), Vector2i(68, 73), Vector2i(-42, 69), null, Vector2i(30, -6), Vector2i(32, 11), Vector2i(-8, 49), null]
